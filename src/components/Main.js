...
<Container>
    ...
    <h3 className="has-text-centered has-text-weight-semibold has-text-grey">ABOUT OUR STUDIO</h3>
    <span className=" is-size-3 has-text-black">
    <h1 className="head has-text-centered  has-text-weight-bold">THE CAMERA IS AN INSTRUMENT THAT TEACHES</h1>
    <h1 className="has-text-centered  has-text-weight-bold">PEOPLE HOW TO SEE WITHOUT A CAMERA</h1>
    </span>
